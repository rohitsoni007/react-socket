...
var SocketProvider = function (_React$Component) {
  (0, _inherits3.default)(SocketProvider, _React$Component);

  function SocketProvider(props) {
    (0, _classCallCheck3.default)(this, SocketProvider);

    var _this = (0, _possibleConstructorReturn3.default)(this, (SocketProvider.__proto__ || (0, _getPrototypeOf2.default)(SocketProvider)).call(this, props));
  ...
  (0, _createClass3.default)(SocketProvider, [{
    key: 'mergeOptions',
